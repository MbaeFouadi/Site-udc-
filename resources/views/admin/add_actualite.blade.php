    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
			<div class="col-lg-12 col-md-12">
				<div class="card">
					<div class="header">
						<h2>Ajouter une nouvelle <small>actualité</small> </h2>
					...
					<div class="body">
                        ...
                        <div class="row clearfix">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" name="contenu" class="form-control" placeholder="Contenu">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row clearfix">
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                    ...
                                    <div class="fallback">
                                        <input name="img_actualites" type="file" />
                                    </div>
