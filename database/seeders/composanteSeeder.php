...
class composanteSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        DB::table("composantes")->insert([
            ...
            'slug' => Str::slug("Faculté de Droit et Sciences Economiques", "-"),
            ...
            'img_comp' => $faker->imageUrl(360, 360, 'fashion'),
        ...
        DB::table("composantes")->insert([
            ...
            'slug' => Str::slug("Faculté des Lettres et Sciences Humaines", "-"),
        ...
        DB::table("composantes")->insert([
            ...
            'slug' => Str::slug("Faculté Imam Chafiou des Lettres Arabes et Sciences Islamiques", "-"),
        ...
        DB::table("composantes")->insert([
            ...
            'slug' => Str::slug("Faculté des Sciences et Techniques", "-"),
        ...
        DB::table("composantes")->insert([
            ...
            'slug' => Str::slug("Institut Universitaire de Technologie", "-"),
        ...
        DB::table("composantes")->insert([
            ...
            'slug' => Str::slug("Institut de Formation des Enseignants et de Recherche en Education", "-"),
        ...
        DB::table("composantes")->insert([
            ...
            'slug' => Str::slug("Ecole de Médecine et de Santé Publique", "-"),
        ...
        DB::table("composantes")->insert([
            ...
            'slug' => Str::slug("Centre Universitaire de Patsy", "-"),
        ...
        DB::table("composantes")->insert([
            ...
            'slug' => Str::slug("Centre Universitaire de Mohéli", "-"),
        ...
        DB::table("composantes")->insert([
            'code_comp' => 'SUFOP',
            'design_comp' => 'Site Universitaire de Formation Permanente',
            'slug' => Str::slug("Site Universitaire de Formation Permanente", "-"),
            'description' => "Le Site Universitaire de Formation Permanente est une composante de l'Université des Comores créé en 2006. Dix ans plus tard, le Centre devient le Service Universitaire de Formation Permanente (SUFOP).
